...
wp_enqueue_style('breezycv-main-styles', get_template_directory_uri().'/css/main.css',array(),'1.7.0');

if ( is_rtl() ) {
    wp_enqueue_style('breezycv-rtl-styles', get_template_directory_uri().'/css/rtl.css',array(),'1.7.0');
}
...
if ($theme_style == 'light') {
	...
	wp_enqueue_style('breezycv-customization', get_template_directory_uri().'/css/customization.css',array(),'1.7.0');
	wp_add_inline_style( 'breezycv-customization', breezycv_theme_customizations() );
} else {
	wp_enqueue_style('breezycv-dark-styles', get_template_directory_uri().'/css/dark-styles.css',array(),'1.7.0');
...
if ( is_page_template('page-templates/template-breezycv-vcard.php') ) {
	wp_enqueue_script('breezycv-animating', get_template_directory_uri().'/js/animating.js',array(),'1.7.0',true);
}
...
wp_enqueue_script('breezycv-jquery-main', get_template_directory_uri().'/js/main.js',array(),'1.7.0',true);
